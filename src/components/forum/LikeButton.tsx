...
const STORAGE_KEY = 'cht_forum_liked';
...
const LikeButton: FC<LikeButtonProps> = ({
  ...
  return (
    <button
      type="button"
      className={`cht-forum__replyAction${liked ? ' cht-forum__replyAction--liked' : ''}`}
      onClick={handleClick}
      disabled={busy || liked}
      aria-pressed={liked}
      aria-label={liked ? `Gefällt mir (${likes})` : `Beitrag mögen (${likes})`}
    >
