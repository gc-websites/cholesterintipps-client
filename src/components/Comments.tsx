...
import { postComment } from '../services/postsAPI';
import './Comments.css';

const MAX_NAME = 40;
const MAX_TEXT = 500;
const PAGE_SIZE = 5;
const STORAGE_KEY = 'cht_commenter_name';
...
const ABS_FORMATTER = new Intl.DateTimeFormat('de-DE', {
  month: 'short',
  day: '2-digit',
  year: 'numeric',
  hour: '2-digit',
...
const SHORT_DATE_WITH_YEAR = new Intl.DateTimeFormat('de-DE', {
  month: 'short',
  day: '2-digit',
  year: 'numeric',
});
...
const Comments = ({ postId, initialComments = [] }: CommentsProps) => {
  ...
  return (
    <section
      ...
      aria-labelledby="cht-comments-title"
    >
      <div className="hfs-comments__card">
          ...
          <div className="hfs-comments__formRow">
            ...
            <div className="hfs-comments__fields">
              ...
              <textarea
                ...
                placeholder="Teilen Sie Ihre Gedanken zu diesem Artikel…"
                value={text}
        ...
        {count === 0 ? (
          <div className="hfs-comments__empty">
            ...
            <p className="hfs-comments__emptyTitle">Noch keine Kommentare</p>
            <p className="hfs-comments__emptyText">
              Seien Sie der Erste, der seine Meinung zu diesem Artikel teilt.
            </p>
          </div>
        ) : (
          <div ref={listRef}>
            <div className="hfs-comments__rangeLabel">
              Zeige <strong>{rangeFrom}</strong>–<strong>{rangeTo}</strong> von{' '}
              <strong>{count}</strong> · neueste zuerst
            </div>
            ...
            {totalPages > 1 && (
              <nav
                ...
                aria-label="Kommentar-Seitennavigation"
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="hfs-comments__pagerLabel">Zurück</span>
                </button>
                ...
                >
                  <span className="hfs-comments__pagerLabel">Weiter</span>
                  <svg
                    viewBox="0 0 24 24"
                    width="14"
                    height="14"
