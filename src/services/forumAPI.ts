...
const SITE = 'cholesterin';

export const FORUM_CATEGORIES: ForumCategory[] = [
  {
    key: 'Ernährung & Lebensmittel',
    slug: 'ernaehrung',
    emoji: '🥗',
    blurb: 'Was essen, was meiden — herzgesunde Lebensmittel und Rezepte.',
  },
  {
    key: 'Bewegung & Sport',
    slug: 'bewegung',
    emoji: '🚶',
    blurb: 'Ausdauer, Krafttraining und Alltag in Bewegung.',
  },
  {
    key: 'Werte & Diagnose',
    slug: 'werte',
    emoji: '🧪',
    blurb: 'LDL, HDL, Triglyceride — Blutbild verstehen und einordnen.',
  },
  {
    key: 'Medikamente & Statine',
    slug: 'medikamente',
    emoji: '💊',
    blurb: 'Statine, Ezetimib und Co. — Wirkung, Nebenwirkungen, Erfahrungen.',
  },
  {
    key: 'Natürliche Hilfe',
    slug: 'natuerliche-hilfe',
    emoji: '🌿',
    blurb: 'Hausmittel, Nahrungsergänzung und Pflanzenkraft.',
  },
  {
    key: 'Erfahrungen & Erfolge',
    slug: 'erfahrungen',
    emoji: '💬',
    blurb: 'Persönliche Geschichten, Fortschritte und gegenseitige Motivation.',
  },
];
...
// Filter to only show threads in the valid cholesterin forum categories.
// Older auto-imported "Discussion: ..." threads with site=cholesterin but
// no proper category are hidden.
